"""
Django settings for bump_48745 project.
...
WSGI_APPLICATION = 'bump_48745.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Bump Support <support@bump-48745.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bump_48745 API",
    "DESCRIPTION": "API documentation for bump_48745 App",
    "VERSION": "v1",
}
